...
#     ./deploy-with-demo-infra.sh my-stack
#
...
# Two ways to supply the network:
#   1. Set VPC_ID / EC2_SUBNET_ID / PRIV_SUBNET_ID_1 / PRIV_SUBNET_ID_2
#      explicitly. Discovery is skipped for whichever are provided.
#   2. Leave them unset and let the tag lookups below find the MMA demo VPC.
#      The tag names themselves are overridable via *_NAME_TAG.
VPC_NAME_TAG="${VPC_NAME_TAG:-MMA-vpc}"
EC2_SUBNET_NAME_TAG="${EC2_SUBNET_NAME_TAG:-MMA-subnet-public1-AvailabilityZone1}"
PRIV_SUBNET_1_NAME_TAG="${PRIV_SUBNET_1_NAME_TAG:-MMA-subnet-private1-AvailabilityZone1}"
PRIV_SUBNET_2_NAME_TAG="${PRIV_SUBNET_2_NAME_TAG:-MMA-subnet-private2-AvailabilityZone2}"
...
aws cloudformation create-stack \
  ...
  --parameters \
    ...
    ParameterKey=UseCloudFront,ParameterValue=false \
