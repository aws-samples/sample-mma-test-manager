...
@Service
public class SybaseMcpTools {

    private static final Logger logger = LoggerFactory.getLogger(SybaseMcpTools.class);
    ...
    @McpTool(name = "sybase_execute_sql", description = "Execute SQL statements and return results for Sybase ASE database operations")
    ...
    @McpTool(name = "sybase_execute_testcase_readonly", description = "Execute test case SQL statements with execution timing and guaranteed no side effects through read-only connections")
    ...
    @McpTool(name = "sybase_execute_testcase_rollback", description = "Execute test case SQL statements with execution timing and guaranteed no side effects through transactional rollback")
